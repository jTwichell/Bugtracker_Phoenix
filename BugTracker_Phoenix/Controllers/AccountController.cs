    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model, HttpPostedFileBase file)
        {
            if (ModelState.IsValid)
            {
                if (ImageUploadValidator.IsWebFriendlyImage(file))
                {
                    ...
                    file.SaveAs(Path.Combine(Server.MapPath("~/photos/Uploads/"), fileName));
                    model.MediaUrl = "/photos/Uploads/" + fileName;
                }

                var user = new ApplicationUser { FirstName = model.FirstName, LastName = model.LastName, DisplayName = model.DisplayName, MediaUrl = model.MediaUrl, UserName = model.Email, Email = model.Email, Gender = model.Gender };
        ...
        public async Task<ActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                var from = "BugSquasher<jasontwichellsr@gmail.com>";
