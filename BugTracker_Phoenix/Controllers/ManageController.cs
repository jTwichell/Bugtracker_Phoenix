...
namespace BugTracker_Phoenix.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        {
            //How do I go out and get just the First Name, Last Name and Display Name data from the Users table??
            var userId = User.Identity.GetUserId();
        ...
        public ActionResult ChangeName([Bind(Include = "Id,FirstName,LastName,DisplayName")] ApplicationUser user)
        {
            if (ModelState.IsValid)
            {
                ...
                //Change this line to state that only specific properties can change
